...
const translations = {
    zh: {
        ...
        news: {
            ...
            paper1_desc: "提出MatEvolve，一个协同符号-LLM智能体框架，将材料设计重新定义为闭环程序化演化任务。通过材料编辑语言(Material Edit Language)、动态知识注入机制和多目标适应度景观，实现材料设计效率提升32.2%，相比传统枚举筛选方法效率提升33.6%。",
            paper2_desc: "提出ToolWeaver，通过将工具编码为层次化序列来解决大规模工具使用的可扩展性问题。该方法使词汇表扩展从线性降至对数级别，并通过学习工具协作模式显著提升性能。在近47,000个工具的评估中显著优于现有方法。",
            papers_summary: "团队在AI材料设计、大模型工具使用等前沿方向取得突破性进展，论文发表于ICAIS、ICLR等国际顶级会议，获得最佳论文奖等学术荣誉。",
            patents_title: "发明专利",
            ...
            patents_summary: "专利信息待补充。",
            achievement1_caption: "ICAIS最佳论文奖",
            achievement2_caption: "The AI Reviewer's Appraisal Award",
    ...
    en: {
        ...
        news: {
            ...
            papers_title: "Conference Papers",
            papers_details_title: "Paper Details:",
            papers_summary_title: "Publication Achievements:",
            paper1_desc: "Proposed MatEvolve, a synergistic symbolic-LLM agent framework that redefines materials design as a closed-loop programmatic evolution task. Through Material Edit Language, dynamic knowledge injection mechanisms and multi-objective fitness landscapes, achieved 32.2% improvement in materials design efficiency, 33.6% efficiency improvement compared to traditional enumeration screening methods.",
            paper2_desc: "Proposed ToolWeaver to solve scalability issues in large-scale tool use by encoding tools as hierarchical sequences. This method reduces vocabulary expansion from linear to logarithmic scale and significantly improves performance by learning tool collaboration patterns. Significantly outperforms existing methods in evaluation of nearly 47,000 tools.",
            papers_summary: "The team has made breakthrough progress in frontier directions such as AI materials design and LLM tool use. Papers have been published in top international conferences such as ICAIS and ICLR, receiving academic honors including Best Paper Award.",
            ...
            patents_summary: "Patent information to be added.",
            achievement1_caption: "ICAIS Best Paper Award",
            achievement2_caption: "The AI Reviewer's Appraisal Award",
