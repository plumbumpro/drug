...
const translations = {
    zh: {
        ...
        hero: {
            ...
            btn_agent: "探索AI智能体",
            btn_pipeline: "查看研发管线",
            metric_pipelines: "在研管线",
            metric_databases: "整合数据源",
            metric_delivery: "立项评估交付",
            metric_accuracy: "结合命中率",
            learn_more: "了解更多",
            learn_more_agent: "了解更多",
        ...
        sections: {
            ...
            proposal: "立项书输出示例",
            proposal_desc: "AI智能体自动生成的立项评估报告结构（脱敏示例）",
        ...
        agent: {
            layer1_title: "临床市场价值层",
            layer1_desc: "通过智能信息引擎，聚合商业信息平台、社媒平台、会议平台等信息，每天推荐最新的极具潜力的靶点和药物，实时汇聚全球临床需求与竞争管线动态。",
            layer1_full: "构建动态情报中枢，通过智能信息引擎聚合商业信息平台、社媒平台、会议平台等信息，每天推荐最新的极具潜力的靶点和药物。实时汇聚全球临床需求、真实世界证据、竞争管线、专利地图与支付政策，通过多源异构数据融合生成高置信度市场洞察与立项方向。",
            layer2_title: "AI科学家层",
            layer2_desc: "内嵌药物研发知识图谱与决策逻辑链，模拟顶尖科学家思维，对靶点生物学合理性、差异化路径、风险矩阵进行深度推演与优先级决策。",
            layer2_full: "内嵌药物研发知识图谱与决策逻辑链，模拟顶尖科学家思维，对靶点生物学合理性、差异化路径、风险矩阵进行深度推演与优先级决策。打破现有AI工具的孤岛状态，贯穿\"情报整合-科学推演-风险权衡\"的智能体级协同。",
            layer3_title: "数字实验室层",
            layer3_desc: "集成生成式分子设计、靶点-配体相互作用模拟、ADMET预测等AI模型，通过多目标强化学习实现亲和力、稳定性等多维度优化。",
            layer3_full: "集成生成式分子设计、靶点-配体相互作用模拟、ADMET预测等AI模型，完成高通量干实验筛选与优化。通过多目标强化学习优化（ZMutation），在突变规则、可合成性等约束下进行Pareto优化。",
            layer4_title: "CRO实验智能管理层",
            layer4_desc: "自主规划湿实验方案、智能调度外部CRO资源，将关键验证数据精准反哺数字实验室，形成干湿闭环迭代。",
            layer4_full: "自主规划湿实验方案、智能调度外部CRO资源、实时监控实验进程，并将关键验证数据精准反哺数字实验室，驱动模型迭代，形成\"情报输入—干实验筛选—湿实验验证—知识进化\"的干湿闭环。"
        },
        feature: {
            modular_title: "模块化设计",
            modular_desc: "AI药物研发系统模块分四个层面：临床市场价值层、AI科学家层、数字实验室层、实验智能管理层。各模块可独立升级、灵活组合，支持多靶点并行运算设计。",
            multi_obj_title: "多目标优化",
            multi_obj_1: "目标分解与可度量化：亲和力、免疫原性、稳定性等权重可调",
            multi_obj_2: "多目标强化学习优化（ZMutation）：Pareto/权重优化",
            multi_obj_3: "实验对齐：结合命中率接近100%，多受体结合读出30+/30+",
            control_title: "可控性",
            control_1: "数据冷启动流水线（LLM+Agent）：流程可追溯、复现",
            control_2: "领域知识约束：靶点要点、突变规则、优化目标模板显式化",
            control_3: "干湿闭环校准：实验readout回流训练，迭代校准预测器与策略",
            robust_title: "泛化与鲁棒性",
            robust_1: "跨文献/机制/靶点覆盖，降低过拟合",
            robust_2: "多层次建模：基础蛋白LM + 多性质预测，避免单一打分坍缩",
            robust_3: "输出多簇差异化候选，支持并行推进与风险对冲",
            empower_title: "平台赋能",
            empower_desc: "赋能药企（尤其中小型Biotech）突破专家资源瓶颈，实现立项决策标准化、智能化。支持创新药重大专项申请、CGT/IIT/CMC政策支持，以及智能药物靶点信息引擎服务。",
            auto_title: "自动化闭环",
        ...
        pipeline: {
            ...
            il2_opt_desc: "AI生成超过40条IL2单体，可表达性成功率超40%，受体结合率超80%，30+条符合进一步开发标准。",
            il2_opt_stage: "序列优化",
            antibody_title: "抗体VHH/VL/VH设计",
            antibody_target: "平台能力拓展",
            antibody_desc: "技术平台可快速迁移至抗体VHH、VL、VH设计与优化，具有广阔的产业转化潜力。",
            antibody_stage: "平台验证",
            combo_title: "成熟靶点新组合挖掘",
            combo_target: "多靶点组合策略",
            combo_desc: "基于智能信息引擎，挖掘成熟靶点的新组合方案，结合高通量实验验证，突破\"热门靶点内卷\"困局。",
            combo_stage: "靶点筛选",
            batch_title: "多靶点并行运算",
            batch_target: "AI自主立项平台",
            batch_desc: "将单管线验证能力系统性扩展为可复用、可迭代的AI自主立项平台，不再局限于\"热门靶点陷阱\"。",
            batch_stage: "平台建设",
            view_all: "查看完整管线"
        },
        cold: {
        ...
        proposal: {
            title: "AI立项评估报告 — [靶点名称]",
            s1_title: "1. 靶点概述与生物学背景",
            s1_desc: "靶点基因/蛋白信息、信号通路、在疾病中的作用机制、已知配体与调控关系",
            s2_title: "2. 市场竞争格局分析",
            s2_desc: "全球在研管线统计、竞品临床阶段、专利到期时间线、市场规模预测",
            s3_title: "3. 临床未满足需求评估",
            s3_desc: "现有疗法局限性、患者人群特征、临床终点与响应率对比、差异化治疗窗口",
            s4_title: "4. AI设计策略与分子方案",
            s4_desc: "设计路径选择（融合蛋白/抗体/多肽）、多目标优化参数、候选分子序列与预测性质",
            s5_title: "5. 风险矩阵与缓解方案",
            s5_desc: "技术风险、临床风险、竞争风险评级、对应缓解策略与备选方案",
            s6_title: "6. 实验验证计划与里程碑",
            s6_desc: "干实验筛选→湿实验验证时间线、关键决策节点、预算估算与CRO对接方案"
        },
        pipeline_page: {
            feature_title: "PD1-IL2：汇聚前沿生物学洞见与转化潜力的关键靶点",
            feature_desc1: "PD1-IL2融合蛋白的开发不仅具备严谨的科学依据与千亿规模的市场，更承载着肿瘤免疫治疗下一阶段突破的重要使命。",
            feature_desc2: "IL2作为连接抗体与多肽的关键细胞因子，其深入研究将同步推动两类治疗模式的平台化发展，为系统性攻克肿瘤提供更丰富的工具与路径。本项目所建立的研究体系具备高度可拓展性，相关技术平台可快速迁移至同类机制药物的开发中，形成持续研发动能。"
        },
        result: {
            express_title: "可表达性",
            express_desc: "成功率超过40%，成功表达了40多条IL2单体",
            binding_title: "受体结合",
            binding_desc: "可与超过80%受体结合，符合进一步开发标准的超过30条",
            cell_title: "细胞实验筛选",
            cell_desc: "30余个候选单体中，挑选16个进行细胞实验，荧光实验挑选8个区分度较大的分子",
            fusion_title: "融合蛋白构建",
            fusion_desc: "8个蛋白构建Fc/PD1融合蛋白进行PBMC实验，pSTAT5筛选出4个候选蛋白",
            candidate_title: "候选蛋白品质",
            candidate_desc: "4个候选蛋白(0008/0042/0059/0085)表达纯化良好，瞬转表达量150-500mg/L，纯度超过90%",
            animal_title: "动物实验",
            animal_desc: "0042、0085的MC38动物实验结果良好。AI仍有近百条IL2序列待鉴定，现有4个IL2已初步具备PCC分子潜力",
        ...
        cold_result: {
            ...
            ai_title: "AI精准发现",
            ai_desc: "AI准确找到了药效与安全更佳分子：0059K、0008K在细胞实验中活性强于2149的分子暂时未出现动物死亡。",
            purity_title: "纯度提升方向",
            purity_desc: "对高剂量实验，纯度需进一步提升。推测除剂量依赖毒性外，还可能存在杂质影响。"
        },
    ...
    en: {
        ...
        hero: {
            ...
            index_tagline: "AI Target & Cold Tumor Drug Autonomous Discovery",
            index_description: "A full-chain drug R&D platform powered by multi-agent collaboration, integrating cutting-edge AI with tumor immunology to address unmet clinical needs and accelerate from target discovery to candidate molecules.",
            btn_agent: "Explore AI Agent",
            btn_pipeline: "View Pipeline",
            metric_pipelines: "Active Pipelines",
            metric_databases: "Integrated Sources",
            metric_delivery: "Assessment Delivery",
            metric_accuracy: "Binding Hit Rate",
            learn_more: "Learn More",
            learn_more_agent: "Learn More",
            team_title: "World-Class Research Team",
            team_subtitle: "Gathering interdisciplinary elites to tackle the ultimate challenges in drug discovery.",
            ...
            recruit_subtitle: "Open positions: Inviting young talents passionate about drug R&D, medicine, and AI to join us.",
            agent_title: "AI Agent Platform",
            agent_subtitle: "Autonomous, Modular, Automated, Scalable — A New Paradigm Beyond Traditional Drug Design",
            pipeline_title: "R&D Pipeline",
            pipeline_subtitle: "Focused on cold tumors, AI-driven full-chain drug development from target to candidate molecule"
        },
        sections: {
            intro: "Project Introduction",
            ai_agent_intro: "AI Agent Platform",
            ai_agent_intro_desc: "Four intelligent layers working in synergy to build a full-chain smart drug R&D system",
            pipeline_overview: "Pipeline Overview",
            pipeline_overview_desc: "Focused on high-value areas like cold tumors, AI drives parallel pipeline advancement",
            cold_tumor: "Why Focus on Cold Tumors",
            cold_tumor_desc: "Cold tumors represent the next breakthrough in immunotherapy and the largest unmet clinical need",
            architecture: "System Architecture",
            architecture_desc: "The AI drug R&D system spans four layers, forming a complete intelligent R&D closed loop",
            core_features: "Core Technical Features",
            proposal: "Project Proposal Output Example",
            proposal_desc: "Structure of AI agent auto-generated project assessment report (desensitized example)",
            pipeline_feature: "Pipeline Features",
            ai_results: "AI Design Results",
            ai_results_desc: "AI-generated sequences evaluated by biology experts, data visualizing R&D progress",
            cold_tumor_results: "Cold Tumor Experimental Results",
            pipeline_extend: "Platform Extension Pipelines",
        ...
        faq: {
            ...
            q5: "What are cold tumors? Why are they an important research direction?",
            a5: "Cold tumors refer to tumor microenvironments with low immune cell infiltration, resulting in poor patient response to immunotherapies like checkpoint inhibitors. Over 70% of solid tumors are cold tumor phenotype, representing the largest unmet need in tumor immunotherapy. We use PD1-IL2 fusion protein strategy to 'heat up' cold tumors into immunologically active hot tumors, breaking through treatment barriers."
        },
        team: {
        ...
        agent: {
            layer1_title: "Clinical Market Value Layer",
            layer1_desc: "Through intelligent information engines, aggregating business, social media, and conference platforms to recommend the most promising targets and drugs daily, tracking global clinical needs and pipeline dynamics.",
            layer1_full: "Building a dynamic intelligence hub, aggregating business, social media, and conference platform data through intelligent engines to recommend promising targets and drugs daily. Real-time aggregation of global clinical needs, real-world evidence, competitive pipelines, patent maps, and payment policies, generating high-confidence market insights through multi-source data fusion.",
            layer2_title: "AI Scientist Layer",
            layer2_desc: "Embedding drug R&D knowledge graphs and decision logic chains, simulating top scientist thinking for deep reasoning on target biology, differentiation paths, and risk matrices.",
            layer2_full: "Embedding drug R&D knowledge graphs and decision logic chains, simulating top scientist thinking for deep reasoning and priority decisions on target biological rationality, differentiation paths, and risk matrices. Breaking down AI tool silos with agent-level collaboration spanning intelligence integration, scientific reasoning, and risk assessment.",
            layer3_title: "Digital Laboratory Layer",
            layer3_desc: "Integrating generative molecular design, target-ligand interaction simulation, and ADMET prediction AI models, achieving multi-dimensional optimization through multi-objective reinforcement learning.",
            layer3_full: "Integrating generative molecular design, target-ligand interaction simulation, and ADMET prediction AI models for high-throughput dry-lab screening and optimization. Multi-objective reinforcement learning optimization (ZMutation) performing Pareto optimization under mutation rules and synthesizability constraints.",
            layer4_title: "CRO Experiment Management Layer",
            layer4_desc: "Autonomously planning wet-lab experiments, intelligently dispatching external CRO resources, and feeding key validation data back to the digital laboratory for dry-wet loop iteration.",
            layer4_full: "Autonomously planning wet-lab experiments, intelligently dispatching external CRO resources, monitoring experiment progress in real-time, and feeding key validation data back to the digital laboratory to drive model iteration, forming a closed dry-wet loop of intelligence input, dry-lab screening, wet-lab validation, and knowledge evolution."
        },
        feature: {
            modular_title: "Modular Design",
            modular_desc: "The AI drug R&D system spans four layers: Clinical Market Value, AI Scientist, Digital Laboratory, and Experiment Management. Each module can be independently upgraded and flexibly combined, supporting multi-target parallel computation.",
            multi_obj_title: "Multi-Objective Optimization",
            multi_obj_1: "Decomposable & measurable objectives: affinity, immunogenicity, stability with adjustable weights",
            multi_obj_2: "Multi-objective RL optimization (ZMutation): Pareto/weighted optimization",
            multi_obj_3: "Experimental alignment: binding hit rate ~100%, multi-receptor readout 30+/30+",
            control_title: "Controllability",
            control_1: "Data cold-start pipeline (LLM+Agent): traceable, reproducible workflows",
            control_2: "Domain knowledge constraints: target essentials, mutation rules, optimization templates",
            control_3: "Dry-wet loop calibration: experimental readout feedback training, iterative calibration",
            robust_title: "Generalization & Robustness",
            robust_1: "Cross-literature/mechanism/target coverage, reducing overfitting",
            robust_2: "Multi-level modeling: protein LM + multi-property prediction, avoiding single-score collapse",
            robust_3: "Multi-cluster differentiated candidates, supporting parallel advancement and risk hedging",
            empower_title: "Platform Empowerment",
            empower_desc: "Empowering pharma companies (especially small Biotechs) to break through expert resource bottlenecks, standardizing and intelligentizing project decisions. Supporting innovative drug applications, CGT/IIT/CMC policy support, and intelligent drug target information engine services.",
            auto_title: "Automated Closed Loop",
            auto_desc: "Intelligence layer auto-generates structured reports, digital lab outputs auto-convert to CRO-executable protocols. Through lightweight API integration with partner CROs, achieving fully automated dry-lab prediction, wet-lab validation, feedback, and model fine-tuning."
        },
        pipeline: {
            badge_cold: "Cold Tumor Pipeline",
            badge_standard: "Extension Pipeline",
            badge_batch: "Scalable",
            z212_target: "Target: PD1 + IL2",
            z212_desc: "Four AI-designed candidate molecules all showed clear efficacy against cold tumors, with superior dosage window and good animal experiment results.",
            z212_stage: "Preclinical Research",
            il2_opt_title: "IL2 Variant Optimization",
            il2_opt_target: "Target: IL2 Receptor Selectivity",
            il2_opt_desc: "AI generated 40+ IL2 monomers with >40% expressibility success rate, >80% receptor binding, 30+ meeting further development criteria.",
            il2_opt_stage: "Sequence Optimization",
            antibody_title: "Antibody VHH/VL/VH Design",
            antibody_target: "Platform Capability Extension",
            antibody_desc: "Technology platform rapidly transferable to antibody VHH, VL, VH design and optimization with broad industrial translation potential.",
            antibody_stage: "Platform Validation",
            combo_title: "Novel Combinations for Established Targets",
            combo_target: "Multi-target Combination Strategy",
            combo_desc: "Leveraging intelligent information engines to discover novel combinations for established targets, breaking the 'hot target competition' dilemma.",
            combo_stage: "Target Screening",
            batch_title: "Multi-target Parallel Computing",
            batch_target: "AI Autonomous Project Platform",
            batch_desc: "Systematically extending single-pipeline validation into a reusable, iterable AI autonomous project platform, beyond 'hot target traps'.",
            batch_stage: "Platform Building",
            view_all: "View Full Pipeline"
        },
        cold: {
            challenge_title: "Treatment Challenge",
            challenge_desc: "Cold tumors lack immune cell infiltration and show extremely low response rates to mainstream PD-1/PD-L1 immune checkpoint inhibitors, representing one of the largest unmet clinical needs. Over 70% of solid tumors exhibit the 'cold tumor' phenotype.",
            solution_title: "AI Solution",
            solution_desc: "Our AI platform uses PD1-IL2 fusion protein strategy to both block immune evasion and activate immune cells, converting 'cold tumors' into 'hot tumors'. Multi-objective optimization ensures optimal balance of efficacy and safety.",
            market_title: "Market Opportunity",
            market_desc: "The PD1-IL2 fusion protein track has market potential of hundreds of billions, representing the key direction for the next breakthrough in tumor immunotherapy. Early positioning in the cold tumor field establishes significant competitive barriers."
        },
        proposal: {
            title: "AI Project Assessment Report — [Target Name]",
            s1_title: "1. Target Overview & Biological Background",
            s1_desc: "Target gene/protein information, signaling pathways, disease mechanisms, known ligands and regulatory relationships",
            s2_title: "2. Market Competition Landscape",
            s2_desc: "Global pipeline statistics, competitor clinical stages, patent expiration timelines, market size projections",
            s3_title: "3. Unmet Clinical Need Assessment",
            s3_desc: "Current therapy limitations, patient population characteristics, clinical endpoint comparisons, differentiation windows",
            s4_title: "4. AI Design Strategy & Molecular Plan",
            s4_desc: "Design path selection (fusion protein/antibody/peptide), multi-objective optimization parameters, candidate sequences and predicted properties",
            s5_title: "5. Risk Matrix & Mitigation Plans",
            s5_desc: "Technical, clinical, competitive risk ratings, corresponding mitigation strategies and alternatives",
            s6_title: "6. Experimental Validation Plan & Milestones",
            s6_desc: "Dry-lab screening → wet-lab validation timeline, key decision points, budget estimates and CRO integration plans"
        },
        pipeline_page: {
            feature_title: "PD1-IL2: A Key Target Combining Cutting-edge Biology and Translation Potential",
            feature_desc1: "PD1-IL2 fusion protein development possesses rigorous scientific rationale and a hundred-billion-scale market, carrying the mission of the next breakthrough in tumor immunotherapy.",
            feature_desc2: "As a key cytokine linking antibodies and peptides, deep IL2 research will simultaneously advance two therapeutic modalities toward platform development. The research framework established has high extensibility, enabling rapid migration to similar mechanism drug development."
        },
        result: {
            express_title: "Expressibility",
            express_desc: "Success rate >40%, 40+ IL2 monomers successfully expressed",
            binding_title: "Receptor Binding",
            binding_desc: ">80% receptor binding, 30+ meeting further development criteria",
            cell_title: "Cell Experiment Screening",
            cell_desc: "16 selected from 30+ candidates for cell experiments, 8 with high differentiation selected by fluorescence",
            fusion_title: "Fusion Protein Construction",
            fusion_desc: "8 proteins constructed as Fc/PD1 fusions for PBMC experiments, pSTAT5 selected 4 candidates",
            candidate_title: "Candidate Quality",
            candidate_desc: "4 candidates (0008/0042/0059/0085) with good expression/purification, transient expression 150-500mg/L, purity >90%",
            animal_title: "Animal Experiments",
            animal_desc: "0042, 0085 MC38 animal results good. AI has ~100 more IL2 sequences to evaluate, 4 existing IL2s show PCC potential",
            extend_note: "Research applicable to antibody VHH, VL, VH design and optimization with strong industrial translation potential"
        },
        cold_result: {
            efficacy_title: "All Four Molecules Show Clear Efficacy Against Cold Tumors",
            dosage_title: "Dosage Window",
            dosage_desc: "Superior to Innovent IBI363. 0042K/0085K/2149 max safe dose 30mg/kg, 0008K/0059K at 40mg/kg. Min effective dose 10mg/kg.",
            ai_title: "AI Precision Discovery",
            ai_desc: "AI accurately identified molecules with better efficacy and safety: 0059K, 0008K showed stronger activity than 2149 in cell experiments with no animal deaths observed.",
            purity_title: "Purity Improvement Direction",
            purity_desc: "For high-dose experiments, purity needs further improvement. Suspected impurity effects beyond dose-dependent toxicity."
        },
        interactive: {
